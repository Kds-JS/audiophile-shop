...
const SendNotification = ({isOpen, closeModal} : props) => {
  ...
  const [showMore, setShowMore] = useState(false);
    ...
    return (
        ...
        <div className="relative z-50 p-[30px] max-h-[80vh] overflow-y-scroll w-[92%] md:w-[70%] lg:w-[35%] bg-white shadow-2xl text-black rounded-lg m-auto">
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 items-center justify-center '>
                <div className='bg-secondary-800 py-[25px] px-[25px] rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:rounded-bl-lg'>
                  ...
                  cart.map((item, index) => (
                    <div
                      className="flex flex-wrap justify-between items-start my-[25px]"
                      key={index}
                    >
                      <div className="flex flex-wrap gap-4">
                ...
                <div className='bg-primary-600 h-[100%] py-[25px] flex flex-col justify-center items-center rounded-b-lg md:rounded-b-none md:rounded-tr-lg md:rounded-br-lg '>
