    ...
    return (
        <section className='my-[100px] px-[4%] md:px-[6%] xl:px-[13%]'>
            <div className='grid items-center gap-8 grid-cols-1 lg:grid-cols-2'>
                ...
                <div className='bg-bestgearmobile md:bg-bestgeartablet lg:bg-bestgeardesktop bg-no-repeat bg-center bg-cover h-[300px] lg:h-[568px]  rounded-lg order-1 lg:order-2'>
